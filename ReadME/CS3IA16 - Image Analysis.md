...
## Process overview
![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.001.png)
...
|<p></p><p>![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.002.png)</p><p></p>|
| :-: |
...
|<p></p><p>![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.003.png)</p><p></p>|<p>The frequency domain enables us to see the noises with naked eye. All of the noises in the frequency domain are circled and arrowed in red. These areas are where there is predominantly noise that must be removed. </p><p></p>|
| :-: | :- |


|<p>![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.004.png)</p><p></p>|
| :-: |
...
|![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.005.png)|
| :-: |
...
|<p>![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.006.png)</p><p></p>|
| :-: |
...
|<p></p><p>![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.007.png)       ![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.008.jpeg)</p><p></p>|
| :-: |
...
|<p>![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.009.png)</p><p>         </p>|
| :-: |
...
|<p>![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.010.png)</p><p></p>|
| :-: |
|Once we apply the filter to the centre of the frequency domain, we conduct the Inverse Fourier Shift. We then move the frequency domain from the middle to the upper left corner, which is done using the inverse the fftshift() method. Although identical for even-length x, the functions differ by one sample for odd-length x. Therefore is essential to use even values with the fftshift() method.|



|<p></p><p>![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.011.png)      ![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.012.png)</p><p></p>|
| :-: |
...
|![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.013.png)|
| :-: |
...
|<p>![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.014.png)</p><p></p>|
| :-: |
|Once we apply the filter to the centre of the frequency domain, we conduct the Inverse Fourier Shift. We then move the frequency domain from the middle to the upper left corner, which is done using the inverse the fftshift() method. Although identical for even-length x, the functions differ by one sample for odd-length x. Therefore is essential to use even values with the fftshift() method.|


|![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.015.png)            ![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.016.png)             |
| :-: |
...
|![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.017.png)|
| :-: |
...
|<p>![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.018.png)</p><p></p>|
| :-: |
|Once we apply the filter to the centre of the frequency domain, we conduct the Inverse Fourier Shift. We then move the frequency domain from the middle to the upper left corner, which is done using the inverse the fftshift() method. Although identical for even-length x, the functions differ by one sample for odd-length x. Therefore is essential to use even values with the fftshift() method.|


|<p></p><p>![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.019.png)         ![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.020.png)</p><p></p>|
| :-: |
...
|![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.019.png)          ![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.021.png)|
| :-: |
...
|![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.019.png)           ![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.022.png)|
| :-: |
...
|![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.023.png)              ![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.024.png)|
| :-: |
...
|![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.025.jpeg)           ![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.026.jpeg)|
| :-: |
...
|![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.027.png)              ![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.028.png)|
| :-: |
...
![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.029.png) 
...
|![](Aspose.Words.e4f11237-38ab-43e4-a394-fb71a0fadf15.030.png)|<p>We passed the original distorted image and the filtered image (Low Pass+Bilateral) to the MSE method we made using the above formula.</p><p>The closer the MSE is to 0, the lower the error; our MSE is  0.00067389. Therefore, we removed the image noise drastically even though the image is not visually pleasing.</p>|
| :- | :- |
# References
