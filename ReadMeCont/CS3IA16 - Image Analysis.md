...
## Process overview
![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.001.png)
...
|`                  	`![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.002.png)|
| :- |
...
|![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.003.png)|<p>The frequency domain enables us to see the noises with naked eye. All of the noises in the frequency domain are circled and arrowed in red. These areas are where there is predominantly noise that must be removed. </p><p></p>|
| :- | :- |


|<p>`                 `![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.004.png)</p><p></p>|
| :- |
...
|![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.005.png)                  |
| :- |
...
|<p>`               `![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.006.png)</p><p></p>|
| :- |
...
|![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.007.png)              ![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.008.jpeg) |
| :- |
...
|<p>![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.009.png)     </p><p>         </p>|
| :- |
...
|<p>`               `![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.010.png)</p><p></p>|
| :- |
|Once we apply the filter to the centre of the frequency domain, we conduct the Inverse Fourier Shift. We then move the frequency domain from the middle to the upper left corner, which is done using the inverse the fftshift() method. Although identical for even-length x, the functions differ by one sample for odd-length x. Therefore is essential to use even values with the fftshift() method.|



|![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.011.png)            ![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.012.png) |
| :- |
...
|`             `![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.013.png)|
| :- |
...
|<p>`               `![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.014.png)</p><p></p>|
| :- |
|Once we apply the filter to the centre of the frequency domain, we conduct the Inverse Fourier Shift. We then move the frequency domain from the middle to the upper left corner, which is done using the inverse the fftshift() method. Although identical for even-length x, the functions differ by one sample for odd-length x. Therefore is essential to use even values with the fftshift() method.|


|![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.015.png)            ![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.016.png)             |
| :-: |
...
|`                  `![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.017.png)|
| :-: |
...
|<p>`                     `![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.018.png)</p><p></p>|
| :- |
|Once we apply the filter to the centre of the frequency domain, we conduct the Inverse Fourier Shift. We then move the frequency domain from the middle to the upper left corner, which is done using the inverse the fftshift() method. Although identical for even-length x, the functions differ by one sample for odd-length x. Therefore is essential to use even values with the fftshift() method.|


|![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.019.png)                      ![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.020.png)                        |
| :- |
...
|![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.019.png)                        ![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.021.png)|
| :- |
...
|![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.019.png)                        ![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.022.png)|
| :- |
...
|![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.023.png)                          ![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.024.png)|
| :- |
...
|![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.025.jpeg)                         ![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.026.jpeg)|
| :- |
...
|![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.027.png)                                 ![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.028.png)|
| :- |
...
![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.029.png) 
...
|![](Aspose.Words.557f710f-9162-4c9f-b1e9-7fdb21cf5bf7.030.png)|<p>We passed the original distorted image and the filtered image (Low Pass+Bilateral) to the MSE method we made using the above formula.</p><p>The closer the MSE is to 0, the lower the error; our MSE is  0.00067389. Therefore, we removed the image noise drastically even though the image is not visually pleasing.</p>|
| :- | :- |
